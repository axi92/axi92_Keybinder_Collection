...
WriteMemorySelf(hwnd,address,writevalue,datatype="int",length=4,offset=0)
{
...
ReadMemorySelf(hwnd,address,datatype="int",length=4,offset=0)
{
...
{
baseresult := ReadMemorySelf(hwnd,base)
...
return WriteMemorySelf(hwnd,address,writevalue,datatype,length)
}
...
return ReadMemorySelf(hwnd,base,datatyp,length)
}
...
WriteMemoryValueToProgram(WVALUE,MADDRESS,PROGRAM)
{
